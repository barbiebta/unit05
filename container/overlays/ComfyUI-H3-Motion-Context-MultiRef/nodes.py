...
from .h3_masked_bridge import (
    MiniMaxH3MaskedAVBridge,
    MiniMaxH3Instrumentality,
    MiniMaxH3CompressedContextBridge,
    MiniMaxH3CompressGeneratedMiddleLatent,
    MiniMaxH3InstrumentalityDecodeAV,
    MiniMaxH3InstrumentalityExtractMiddle,
)
...
NODE_CLASS_MAPPINGS = {
    ...
    "MiniMaxH3Instrumentality": MiniMaxH3Instrumentality,
    "MiniMaxH3CompressedContextBridge": MiniMaxH3CompressedContextBridge,
    "MiniMaxH3CompressGeneratedMiddleLatent": MiniMaxH3CompressGeneratedMiddleLatent,
    "MiniMaxH3InstrumentalityDecodeAV": MiniMaxH3InstrumentalityDecodeAV,
    "MiniMaxH3InstrumentalityExtractMiddle": MiniMaxH3InstrumentalityExtractMiddle,
...
NODE_DISPLAY_NAME_MAPPINGS = {
    ...
    "MiniMaxH3Instrumentality": "Instrumentality · fill AV gap v1",
    "MiniMaxH3CompressedContextBridge": "Instrumentality · compress 90-frame contexts to 39",
    "MiniMaxH3CompressGeneratedMiddleLatent": "Instrumentality · compress generated middle latent",
    "MiniMaxH3InstrumentalityDecodeAV": "Instrumentality · decode AV v1",
    "MiniMaxH3InstrumentalityExtractMiddle": "Instrumentality · extract generated gap v1",
